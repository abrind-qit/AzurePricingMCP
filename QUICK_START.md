...
```json
{
  "mcpServers": {
    "azure-pricing": {
      "command": "python",
      "args": ["-m", "azure_pricing_server"],
      "cwd": "/absolute/path/to/azure-pricing-mcp"
    }
  }
}
```
...
```bash
python -c "import azure_pricing_server"
```
...
<p align="center">
  <b>Need help?</b> Open an <a href="https://github.com/charris-msft/azure-pricing-mcp/issues">issue</a> on GitHub!
</p>
